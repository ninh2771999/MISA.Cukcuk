<template>
    <div class="m-menu">
                <div class="m-logo-container">
                    ...
                    <img class="m-logo-icon" src="../../assets/img/Logo_Module_TiengViet_White.66947422.svg" alt="Logo_Module_TiengViet_White">
                </div>
                <div class="m-menu-item">
                    <div class="m-tooltip-content">
                        <router-link to="/employee" class="m-item-router">
                    ...
                    <div class="m-tooltip-content">
                        <router-link to="/report" class="m-item-router">
